...
$tab = match($path) { 'top' => 'top', default => $_GET['tab'] ?? 'new' };
...
<body class="bg-bg text-txt min-h-screen">
    ...
    <header class="max-w-[36rem] mx-auto px-4 pt-8 pb-4">
        ...
        <p id="liveDesc" class="text-muted mt-6 text-center">Așa că le-am adunat pentru tine. <span style="text-decoration: underline; text-decoration-color: <?= e($settings['color_accent']) ?>; text-decoration-thickness: 2px; text-underline-offset: 4px;">Adaugă-ți și tu</span> articolele preferate și <span style="text-decoration: underline; text-decoration-color: <?= e($settings['color_accent']) ?>; text-decoration-thickness: 2px; text-underline-offset: 4px;">lasă un like</span> celor mai bune.</p>
    ...
    <main class="max-w-[36rem] mx-auto px-4 pb-12">
        ...
        <div class="text-center py-16">
            ...
            <a href="/articol-nou" class="text-accent hover:underline mt-2 inline-block">Fii primul care adauga unul!</a>
        </div>
        <?php endif; ?>
        ...
        <div class="text-center py-10">
            ...
            <a href="/articol-nou" class="inline-block bg-accent text-white px-6 py-3 rounded-xl font-semibold hover:opacity-90 transition-opacity">
                + Adaugă un articol
            </a>
        </div>
        <?php endif; ?>
