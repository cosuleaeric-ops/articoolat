...
<body class="bg-bg text-txt min-h-screen">
    ...
    <header class="max-w-[36rem] mx-auto px-4 pt-8 pb-4">
        ...
        <p id="liveDesc" class="text-muted mt-6 text-center">Așa că le-am adunat pentru tine. <span style="text-decoration: underline; text-decoration-color: <?= e($settings['color_accent']) ?>; text-underline-offset: 3px;">Adaugă-ți și tu</span> articolele preferate și <span style="text-decoration: underline; text-decoration-color: <?= e($settings['color_accent']) ?>; text-underline-offset: 3px;">lasă un like</span> celor mai bune.</p>
